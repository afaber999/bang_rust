...
impl<'a> BasmCompiler<'a> {
    ...
    fn reinterpret_expr_as_type(
        ...
        user_error!("{} Expected type name", &expr.loc.fmt_err());
    }
    ...
    fn compile_var_read(
        ...
        user_error!("{} Can't read variable name {}",&var_read.loc.fmt_err(), &var_read.name);
    }
